...
namespace STrackerServer.App_Start
{
    ...
    public static class WebApiConfig
    {
        ...
        public static void Register(HttpConfiguration config)
        {
            ...
            // Routes for users.
            config.Routes.MapHttpRoute("api_users_post", "api/user", new { controller = "users", action = "post" });
            config.Routes.MapHttpRoute("api_users_get", "api/user/{userId}", new { controller = "users", action = "get" });
