intellisense.annotate(jQuery, {
  ...
  'ajaxTransport': function() {
    ...
    ///   <param name="dataType" type="String">A string Keyentifying the data type to use</param>
    ///   <param name="handler(options, originalOptions, jqXHR)" type="Function">A handler to return the new transport object to use with the data type provKeyed in the first argument.</param>
    /// </signature>
  },
  'boxModel': function() {
  ...
  'Callbacks': function() {
    /// <signature>
    ///   <summary>A multi-purpose callbacks list object that provKeyes a powerful way to manage callback lists.</summary>
  ...
  'cssHooks': function() {
    /// <summary>Hook directly into jQuery to overrKeye how particular CSS properties are retrieved or set, normalize CSS property naming, or create custom properties.</summary>
    /// <returns type="Object" />
  },
  'data': function() {
    /// <signature>
  ...
  'grep': function() {
    ...
    ///   <param name="invert" type="Boolean">If "invert" is false, or not provKeyed, then the function returns an array consisting of all elements for which "callback" returns true.  If "invert" is true, then the function returns an array consisting of all elements for which "callback" returns false.</param>
    ///   <returns type="Array" />
    /// </signature>
  },
  'hasData': function() {
  ...
  'when': function() {
    /// <signature>
    ///   <summary>ProvKeyes a way to execute callback functions based on one or more objects, usually Deferred objects that represent asynchronous events.</summary>
...
intellisense.annotate(jQuery.fn, {
  ...
  'child': function() {
    ...
    ///   <param name="parent" type="String">Any valKey selector.</param>
  ...
  'descendant': function() {
    ...
    ///   <param name="ancestor" type="String">Any valKey selector.</param>
  ...
  'fadeOut': function() {
    /// <signature>
    ///   <summary>HKeye the matched elements by fading them to transparent.</summary>
    ///   <param name="duration" type="">A string or number determining how long the animation will run.</param>
    ///   <param name="complete" type="Function">A function to call once the animation is complete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  ...
  'fadeToggle': function() {
    /// <signature>
    ///   <summary>Display or hKeye the matched elements by animating their opacity.</summary>
    ///   <param name="duration" type="">A string or number determining how long the animation will run.</param>
    ///   <param name="easing" type="String">A string indicating which easing function to use for the transition.</param>
    ///   <param name="complete" type="Function">A function to call once the animation is complete.</param>
    ///   <returns type="jQuery" />
  ...
  'hidden': function() {
    /// <summary>Selects all elements that are hKeyden.</summary>
  },
  'hide': function() {
    /// <signature>
    ///   <summary>HKeye the matched elements.</summary>
    ///   <param name="duration" type="">A string or number determining how long the animation will run.</param>
    ///   <param name="complete" type="Function">A function to call once the animation is complete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  ...
  'id': function() {
    /// <signature>
    ///   <summary>Selects a single element with the given Key attribute.</summary>
    ///   <param name="Key" type="String">An ID to search for, specified via the Key attribute of an element.</param>
    /// </signature>
  },
  'image': function() {
  ...
  'innerWidth': function() {
    /// <summary>Get the current computed wKeyth for the first element in the set of matched elements, including padding but not border.</summary>
    /// <returns type="Integer" />
  },
  'input': function() {
  ...
  'multiple': function() {
    ...
    ///   <param name="selector1" type="String">Any valKey selector.</param>
    ///   <param name="selector2" type="String">Another valKey selector.</param>
    ///   <param name="selectorN" type="String">As many more valKey selectors as you like.</param>
    /// </signature>
  },
  'next': function() {
    /// <signature>
    ///   <summary>Get the immediately following sibling of each element in the set of matched elements. If a selector is provKeyed, it retrieves the next sibling only if it matches that selector.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'next adjacent': function() {
    ...
    ///   <param name="prev" type="String">Any valKey selector.</param>
  ...
  'outerWidth': function() {
    /// <signature>
    ///   <summary>Get the current computed wKeyth for the first element in the set of matched elements, including padding and border.</summary>
    ///   <param name="includeMargin" type="Boolean">A Boolean indicating whether to include the element's margin in the calculation.</param>
    ///   <returns type="Integer" />
    /// </signature>
  },
  ...
  'replaceWith': function() {
    /// <signature>
    ///   <summary>Replace each element in the set of matched elements with the provKeyed new content and return the set of elements that was removed.</summary>
  ...
  'slideDown': function() {
    /// <signature>
    ///   <summary>Display the matched elements with a slKeying motion.</summary>
    ///   <param name="duration" type="">A string or number determining how long the animation will run.</param>
    ///   <param name="complete" type="Function">A function to call once the animation is complete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  ...
  'slideToggle': function() {
    /// <signature>
    ///   <summary>Display or hKeye the matched elements with a slKeying motion.</summary>
    ///   <param name="duration" type="">A string or number determining how long the animation will run.</param>
    ///   <param name="complete" type="Function">A function to call once the animation is complete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  ...
  'slideUp': function() {
    /// <signature>
    ///   <summary>HKeye the matched elements with a slKeying motion.</summary>
    ///   <param name="duration" type="">A string or number determining how long the animation will run.</param>
    ///   <param name="complete" type="Function">A function to call once the animation is complete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  ...
  'target': function() {
    /// <summary>Selects the target element indicated by the fragment Keyentifier of the document's URI.</summary>
  },
  'text': function() {
    /// <signature>
  ...
  'toggle': function() {
    /// <signature>
    ///   <summary>Display or hKeye the matched elements.</summary>
    ///   <param name="duration" type="">A string or number determining how long the animation will run.</param>
    ///   <param name="complete" type="Function">A function to call once the animation is complete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    ...
    /// <signature>
    ///   <summary>Display or hKeye the matched elements.</summary>
    ///   <param name="showOrHKeye" type="Boolean">A Boolean indicating whether to show or hKeye the elements.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'width': function() {
    /// <signature>
    ///   <summary>Set the CSS wKeyth of each element in the set of matched elements.</summary>
    ...
    /// <signature>
    ///   <summary>Set the CSS wKeyth of each element in the set of matched elements.</summary>
    ///   <param name="function(index, wKeyth)" type="Function">A function returning the wKeyth to set. Receives the index position of the element in the set and the old wKeyth as arguments. Within the function, this refers to the current element in the set.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'wrap': function() {
